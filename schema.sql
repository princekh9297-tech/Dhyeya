...
CREATE UNIQUE INDEX IF NOT EXISTS uq_test_questions_pair ON test_questions(test_id,question_id);
...
-- Legacy database compatibility: add columns that may be missing from an older question_attempts table.
...
-- Battle timer compatibility migration
